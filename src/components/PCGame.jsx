...
class PCGame extends Component {
    constructor(props) {
        super(props);
        this.state = {games: []};
    ...
    async componentDidMount() {
        try {
            const page = this.getRandomPage(100) 
            const response = await fetch(`https://api.rawg.io/api/games?platforms=4&page_size=20&page=${page}`)
