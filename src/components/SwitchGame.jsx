...
class SwitchGame extends Component {
    constructor(props) {
        super(props);
        this.state = {games: []};
    ...
    async componentDidMount() {
        try {
            const page = this.getRandomPage(158) 
            const response = await fetch(`https://api.rawg.io/api/games?platforms=7&page_size=20&page=${page}`)
