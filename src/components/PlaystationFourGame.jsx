...
class PlaystationFourGame extends Component {
    constructor(props) {
        super(props);
        this.state = {games: []};
    ...
    async componentDidMount() {
        try {
            const page = this.getRandomPage(230) 
            const response = await fetch(`https://api.rawg.io/api/games?platforms=18&page_size=20&page=${page}`)
...
export default PlaystationFourGame;